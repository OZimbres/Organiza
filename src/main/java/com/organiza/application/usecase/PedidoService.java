...
public class PedidoService {
    ...
    private final SQLiteMesaRepository mesaRepository;
    private final SQLitePedidoRepository pedidoRepository;

    public PedidoService(SQLiteMesaRepository mesaRepository, SQLitePedidoRepository pedidoRepository) {
